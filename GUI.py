...
class Grid:
    # easy board is used to demonstrate how the algorithm works
    # both boards are solved instantly in the text mode
    # the GUI mode solves the easy board in ~20 seconds and the hard board in ~16 minutes
